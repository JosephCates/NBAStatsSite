<?php
function createTeamID($name, $year) {
    $teamID = "";
    ...
    if ($name == "New York Nets" && $year != 1977) {
        $teamID = "NYA";
    }
    if ($name == "New York Nets" && $year == 1977) {
        $teamID = "NYN";
    ...
    if ($name == "Charlotte Hornets" && $year > 2014) {
        $teamID = "CHO";
    }
    if ($name == "Charlotte Hornets" && $year < 2014) {
        $teamID = "CHH";
    ...
    if ($name == "Denver Nuggets" && $year > 1976) {
        $teamID = "DEN";
    }
    if ($name == "Denver Nuggets" && $year <= 1976) {
        $teamID = "DNA";
    ...
    if ($name == "Indiana Pacers" && $year <= 1976) {
        $teamID = "INA";
    }
    if ($name == "Indiana Pacers" && $year > 1976) {
        $teamID = "IND";
    ...
    if ($name == "San Antonio Spurs" && $year > 1976) {
        $teamID = "SAS";
    }
